...
@php
    $baseClasses = 'relative inline-flex items-center justify-center rounded-md px-5 py-2.5 font-semibold transition duration-300 ease-in-out focus:outline-none focus:ring-2 focus:ring-offset-2 hover:cursor-pointer';
