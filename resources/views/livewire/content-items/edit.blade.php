                ...
                <form wire:submit="save" enctype="multipart/form-data" novalidate>
                    ...
                    <div class="mt-4">
                        <flux:input
                            ...
                            :label="__('content_items/edit.original_title')"
                            type="text"
                    ...
                    <flux:label class="mt-4">{{ __('content_items/edit.if_series') }}</flux:label>
                    <div class="flex flex-col lg:flex-row gap-4">
                        <div class="flex-1 max-w-3xs">
                            <flux:input wire:model="number_of_seasons" :label="__('content_items/edit.number_of_seasons')" type="number" min="1" max="100" />
                        </div>

                        <div class="flex-1 max-w-3xs">
                            <flux:input wire:model="season_number" :label="__('content_items/edit.season_number')" type="number" min="1" max="100" />
                        </div>

                        <div class="flex-1 max-w-3xs">
                            <flux:input wire:model="number_of_series_of_season" :label="__('content_items/edit.number_of_series_of_season')" type="number" min="1" max="15000" />
                        </div>
                    </div>
                    ...
                    <div class="mt-4">
                        <flux:input
                            ...
                            :label="__('content_items/edit.country_of_origin')"
                            type="text"
                    ...
                    <div class="mt-4">
                        <flux:input
                            wire:model="language"
                            :label="__('content_items/edit.language')"
                            type="text"
